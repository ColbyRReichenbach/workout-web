...
export async function updateOnboardingData(formData: FormData) {
    ...
    const { error } = await supabase
        ...
        .upsert({
            ...
            k5_time_sec: parseFloat(formData.get('k5_time_sec') as string) || 0,
            sprint_400m_sec: parseFloat(formData.get('sprint_400m_sec') as string) || 0,
            row_500m_sec: parseFloat(formData.get('row_500m_sec') as string) || 0,
            ski_1k_sec: parseFloat(formData.get('ski_1k_sec') as string) || 0,
            ai_name: aiName,
