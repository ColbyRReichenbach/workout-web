...
import { loginDemoUser, signInWithEmail, signUpWithEmail, resetPassword, loginWithOAuth } from "@/app/actions/auth";
                        ...
                        {view === 'initial' ? (
                            <div className="space-y-4 slide-in">
                                <button
                                    ...
                                    onMouseEnter={onEnter}
                                    onMouseLeave={onLeave}
                                    className="w-full bg-white text-zinc-900 border border-zinc-200 font-bold py-4 rounded-2xl hover:bg-zinc-50 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-sm grid grid-cols-[1fr_auto_1fr] items-center group disabled:opacity-50 disabled:cursor-not-allowed"
                                >
