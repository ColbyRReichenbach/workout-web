...
export async function getAnalyticsData() {
    ...
    const [
        ...
        supabase.from('logs').select('date, performance_data, segment_name, segment_type, phase_id, tracking_mode, week_number, day_name').eq('user_id', currentUserId).order('date', { ascending: true }),
